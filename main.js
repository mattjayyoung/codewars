...
function isPangram(str){
  let orderedStr = str.toLowerCase().split('').sort().join('').trim()

  let noDuplicates = [...new Set(orderedStr)]
  
  let alpha =  noDuplicates.filter(char => char.toLowerCase() != char.toUpperCase()).join('')
